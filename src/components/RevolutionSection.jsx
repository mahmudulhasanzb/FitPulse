    ...
    <section className="relative bg-bg-dark border-t border-white/5 px-6 md:px-16 py-24 overflow-hidden z-10">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        >
          ...
          >
            We believe fitness should be accessible, data-driven, and
            community-focused. Our platform connects you with the best minds in
            the industry to ensure every drop of sweat counts.
          </motion.p>
          ...
          >
            <div>
              ...
              <div className="text-[10px] md:text-xs font-bold text-neutral-light/60 uppercase tracking-widest mt-1">
                Active Classes
              </div>
            </div>
            <div>
        ...
        <div className="lg:col-span-6 relative w-full flex justify-center lg:justify-end">
          <div className="relative w-full max-w-[500px]">
            ...
            >
              <Image
                src="https://i.ibb.co.com/qLCyLdRf/gym-treadmills.jpg"
