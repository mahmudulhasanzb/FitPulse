  ...
  return (
    <section className="relative bg-bg-dark px-6 md:px-16 py-20 z-10 border-t border-white/5">
      ...
      <motion.div 
        ...
        className="max-w-5xl mx-auto bg-gradient-to-br from-bg-card via-[#171A0E] to-bg-dark border border-white/10 rounded-[32px] px-8 py-16 md:py-20 text-center relative overflow-hidden shadow-2xl"
      >
        ...
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-black italic tracking-tight uppercase text-white mb-6 leading-tight relative z-10">
          ...
          <span 
            ...
            className="text-primary block mt-3"
          >
            TRANSFORMATION?
          </span>
        </h2>
        ...
        <p className="text-sm sm:text-base text-neutral-light/70 max-w-2xl mx-auto mb-10 leading-relaxed relative z-10">
          Join thousands of others who have already taken the first step towards<br className="hidden sm:inline" />
          a healthier, stronger version of themselves.
        </p>
