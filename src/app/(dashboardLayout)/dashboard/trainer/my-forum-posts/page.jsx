...
import { getMyForumPosts } from '@/lib/api/add-forum/data'
      ...
      <div className="max-w-5xl mx-auto space-y-10">
        ...
        {postData.length > 0 ? (
          ...
          <div className="bg-[#13160B] border border-[#1C210E] rounded-3xl p-16 text-center flex flex-col items-center justify-center space-y-4">
            <span className="text-xs font-bold text-[#A4A896]/40 uppercase tracking-widest block font-mono">No Articles Published Yet</span>
            <Link 
              href="/dashboard/trainer/add-forum-post" 
