...
import { addClasses } from '@/lib/api/trainer/action';
                ...
                {imageUrl ? (
                  <div className="absolute inset-0 w-full h-full group">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col items-center justify-center space-y-2">
                      <label htmlFor="file-upload" className="cursor-pointer px-4 py-2 bg-[#D4FF00] text-black font-bold text-xs uppercase rounded-xl hover:scale-105 transition-transform duration-200">
                        Change Image
                      </label>
                    </div>
                  </div>
